...
terraform {
  ...
  backend "s3" {
    ...
    key     = "terraform/idseq/envs/sandbox/components/happy.tfstate"
    encrypt = true
    region  = "us-west-2"
    profile = "default"
...
data "terraform_remote_state" "eks" {
  ...
  config = {
    ...
    key     = "terraform/idseq/envs/sandbox/components/eks.tfstate"
    region  = "us-west-2"
    profile = "default"
...
data "terraform_remote_state" "k8s-core" {
  ...
  config = {
    ...
    key     = "terraform/idseq/envs/sandbox/components/k8s-core.tfstate"
    region  = "us-west-2"
    profile = "default"
