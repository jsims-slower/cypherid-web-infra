...
terraform {
  ...
  backend "s3" {
    ...
    key            = "terraform/idseq/envs/prod/components/web-waf.tfstate"
    encrypt        = true
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "access-management" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/access-management.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "batch" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/batch.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "dashboards" {
  backend = "s3"
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/dashboards.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "downloads" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/downloads.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "email" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/email.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "fivetran-ssh" {
  backend = "s3"
  config = {
...
data "terraform_remote_state" "individual-attr" {
  backend = "s3"
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/individual-attr.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "maintenance" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/maintenance.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "resque" {
  ...
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/resque.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
...
data "terraform_remote_state" "zendesk" {
  backend = "s3"
  config = {
    ...
    bucket         = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state"
    dynamodb_table = "idseq-prod-s3-tf-state-prod-prod-idseq-infra-prod-state-lock"
    key            = "terraform/idseq/envs/prod/components/zendesk.tfstate"
    region         = "us-west-2"
    profile        = "idseq-prod"
